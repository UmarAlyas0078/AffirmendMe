...
class InviteMember : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewBinding = InviteMemberBinding.inflate(inflater, container, false)
...
//            Navigation.findNavController(it).navigate(R.id.action_inviteMember_to_inviteApp)
//        }
    }
